...
def portfolio_stats(returns,Rf,Mkt,startdate=None,enddate=None):
    ...
    excess_rets = (rets - Rf['Rate']).dropna()
    ...
    beta, alpha, R2 = beta_calc(rets, Mkt)
...
def compare_portfolios(startdate,enddate,etfs,values):
    ...
    user_port_stats = portfolio_stats(user_port.returns,Rf,Mkt,None, None)
    ...
    our_port_stats = portfolio_stats(our_port.returns,Rf,Mkt,startdate,enddate)
    ...
    if not dom_port:
        ...
        dom_port_stats = portfolio_stats(dom_port.returns,Rf,Mkt,None,None)
...
if __name__ == "__main__":
    ...
    ##port_stats_1 = portfolio_stats(test_portfolio.returns,Rf,Mkt,None,None)
    
    ###get portfolio stats for a specific date range
    ##port_stats_2 = portfolio_stats(test_portfolio.returns,Rf,Mkt,datetime(2011,1,1),datetime(2013,1,1))
